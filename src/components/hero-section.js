          ...
          <div className="w-1/2 rounded-lg overflow-hidden">
            <div className="relative h-[240px]">
              <img 
                ...
                className="w-full h-full object-cover rounded-lg"
              />
              <div className="absolute inset-0 bg-black bg-opacity-20 flex flex-col justify-end items-center p-4 pb-6">
        ...
        <div className="flex flex-row w-full space-x-4">
          ...
          <div className="w-[70%] relative">
            <div className="relative h-[500px]">
              ...
              />
              <div className="absolute inset-0 bg-black bg-opacity-20 flex flex-col justify-center p-8 md:p-16 rounded-md">
          ...
          <div className="w-[30%] relative">
            <div className="relative h-[500px] overflow-hidden rounded-md">
              ...
              />
              <div className="absolute inset-0 bg-black bg-opacity-20 flex flex-col justify-end items-center p-8 md:p-10 pb-12">
                <div className="text-center">
